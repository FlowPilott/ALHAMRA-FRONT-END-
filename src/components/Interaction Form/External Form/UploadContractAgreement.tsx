...
const UploadContractAgreement = ({ errors, setFormData }) => {
    ...
    <div>
      ...
      <div className="mb-4 flex flex-col md:flex-row md:items-center md:gap-12">
        <label className="mb-1 block text-sm font-normal md:w-[30%]">
          Upload Contract Agreement <span className="text-[#B2282F]">*</span>
        </label>
        <div className="flex w-full flex-col">
          <span>
            <div className="relative w-full">
              <FileUpload
                name="uploadContractAgreement"
          ...
          <span>
            {errors.uploadContractAgreement && (
              <p style={{ color: 'red' }}>{errors.uploadContractAgreement}</p>
            )}
          </span>
        </div>
      </div>
...
export default UploadContractAgreement;
