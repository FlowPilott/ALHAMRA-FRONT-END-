...
const FileUploadRFI = ({ selectedFiles, setSelectedFiles }) => {
  ...
  return (
    <div>
      <div className="mt-1 w-full rounded-md border-2 border-dashed border-[#E8BFC1] p-2 text-center">
        <input
          type="file"
          id="file-input"
          multiple
